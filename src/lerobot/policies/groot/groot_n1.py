...
class GR00TN15Config(PretrainedConfig):
    ...
    backbone_cfg: dict = field(metadata={"help": "Backbone configuration."})
    action_head_cfg: dict = field(metadata={"help": "Action head configuration."})
    action_horizon: int = field(metadata={"help": "Action horizon."})
    action_dim: int = field(metadata={"help": "Action dimension."})
